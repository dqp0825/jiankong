               ...
               // rotation: [{ direction: 'y', degree: 0.25*Math.PI}],//旋转     uuid:'',
                ...
                doors: {
                    ...
                    skins:[ {
                        ...
                        skin_behind: {
                            imgurl: "./res/rack_front_door.jpg",
                        }
                    }]
                },
                skin:{
                    ...
                    skin_up: {
                        skin:{
                            skinColor: 0xff0000,
                            skin_up: { imgurl: "./res/rack_door_back.jpg" },
                            skin_down: { imgurl: "./res/rack_door_back.jpg" },
                            skin_fore: {
                                skinColor: 0xff0000,
                                imgurl: "./res/rack_door_back.jpg"
                            },
                            ...
                            skin_left: { imgurl: "./res/rack_door_back.jpg" },
                            skin_right: { imgurl: "./res/rack_door_back.jpg" },
                        }
                    },
                    skin_down: {
                        skin: {
